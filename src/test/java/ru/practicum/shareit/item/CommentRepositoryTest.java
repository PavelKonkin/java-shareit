...
public class CommentRepositoryTest {
    ...
    void findAllByItemId_whenNotFound_thenReturnEmptyList() {
        List<Comment> actualListOfComments = commentRepository.findAllByItemId(66, sort);
    ...
    void findAllByRequestsId_whenNotFound_thenReturnEmptyList() {
        List<Comment> actualListOfComments = commentRepository.findAllByItemsId(List.of(66));
